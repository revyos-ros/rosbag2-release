## rosbag2 (jazzy) - 0.26.7-1

The packages in the `rosbag2` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy rosbag2 --override-release-repository-push-url git@github.com:revyos-ros/rosbag2-release.git` on `Fri, 13 Jun 2025 02:47:47 -0000`
...
The packages in the `rosbag2` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy rosbag2 --override-release-repository-push-url git@github.com:revyos-ros/rosbag2-release.git` on `Sat, 14 Sep 2024 05:30:31 -0000`
...
The packages in the `rosbag2` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release --ros-distro humble rosbag2 --override-release-repository-push-url git@github.com:revyos-ros/rosbag2-release.git` on `Wed, 14 Aug 2024 04:48:12 -0000`
...
- upstream repository: https://github.com/ros2/rosbag2.git
- release repository: https://github.com/revyos-ros/rosbag2-release.git
- rosdistro version: `0.15.11-2`
- old version: `0.15.11-2`
...
The packages in the `rosbag2` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy rosbag2 --override-release-repository-push-url git@github.com:revyos-ros/rosbag2-release.git` on `Thu, 13 Jun 2024 04:24:38 -0000`
...
## rosbag2 (humble) - 0.15.11-2

The packages in the `rosbag2` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble rosbag2` on `Thu, 30 May 2024 06:47:57 -0000`
...
The packages in the `rosbag2` repository were released into the `humble` distro by running `/usr/bin/bloom-release --override-release-repository-url=git@github.com:revyos-ros/rosbag2-release.git -r humble rosbag2` on `Wed, 29 May 2024 16:23:06 -0000`
...
- upstream repository: https://github.com/ros2/rosbag2.git
- release repository: https://github.com/revyos-ros/rosbag2-release.git
- rosdistro version: `0.15.9-2`
- old version: `0.15.9-2`
...
## rosbag2 (humble) - 0.15.9-2

The packages in the `rosbag2` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble rosbag2` on `Fri, 26 Apr 2024 06:31:47 -0000`
...
The packages in the `rosbag2` repository were released into the `iron` distro by running `/usr/bin/bloom-release --rosdistro iron rosbag2` on `Fri, 14 Jul 2023 01:13:45 -0000`
...
The packages in the `rosbag2` repository were released into the `iron` distro by running `/usr/bin/bloom-release --track iron --rosdistro iron rosbag2` on `Thu, 18 May 2023 21:04:27 -0000`
...
## rosbag2 (rolling) - 0.6.0-1

The packages in the `rosbag2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release rosbag2 --rosdistro rolling` on `Mon, 01 Feb 2021 20:24:46 -0000`
...
## rosbag2 (foxy) - 0.3.6-1

The packages in the `rosbag2` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy rosbag2` on `Wed, 06 Jan 2021 19:12:34 -0000`
...
## rosbag2 (rolling) - 0.5.0-1

The packages in the `rosbag2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling rosbag2` on `Wed, 02 Dec 2020 14:26:00 -0000`
...
## rosbag2 (rolling) - 0.4.0-1

The packages in the `rosbag2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling --edit-track rosbag2` on `Fri, 20 Nov 2020 22:59:56 -0000`
...
## rosbag2 (rolling) - 0.3.5-1

The packages in the `rosbag2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling rosbag2` on `Fri, 20 Nov 2020 22:30:22 -0000`
...
## rosbag2 (foxy) - 0.3.5-1

The packages in the `rosbag2` repository were released into the `foxy` distro by running `/Users/karsten/.pyenv/versions/3.7.4/bin/bloom-release -r foxy rosbag2` on `Mon, 31 Aug 2020 22:21:29 -0000`
...
## rosbag2 (foxy) - 0.3.4-1

The packages in the `rosbag2` repository were released into the `foxy` distro by running `/Users/karsten/.pyenv/versions/3.7.4/bin/bloom-release -r foxy rosbag2` on `Wed, 05 Aug 2020 21:49:04 -0000`
...
## rosbag2 (foxy) - 0.3.3-1

The packages in the `rosbag2` repository were released into the `foxy` distro by running `/Users/karsten/.pyenv/versions/3.7.4/bin/bloom-release -r foxy rosbag2` on `Tue, 23 Jun 2020 19:10:23 -0000`
...
## rosbag2 (foxy) - 0.3.2-1

The packages in the `rosbag2` repository were released into the `foxy` distro by running `/Users/karsten/.pyenv/versions/3.7.4/bin/bloom-release -r foxy rosbag2 --edit` on `Wed, 03 Jun 2020 22:39:42 -0000`
...
## rosbag2 (foxy) - 0.3.1-1

The packages in the `rosbag2` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy rosbag2` on `Mon, 01 Jun 2020 18:21:59 -0000`
...
## rosbag2 (foxy) - 0.3.0-1

The packages in the `rosbag2` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy rosbag2` on `Wed, 27 May 2020 03:20:02 -0000`
...
## rosbag2 (foxy) - 0.2.7-1

The packages in the `rosbag2` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy rosbag2` on `Tue, 12 May 2020 21:26:04 -0000`
...
## rosbag2 (foxy) - 0.2.6-1

The packages in the `rosbag2` repository were released into the `foxy` distro by running `/Users/karsten/.pyenv/versions/3.7.4/bin/bloom-release rosbag2 -r foxy` on `Fri, 08 May 2020 00:55:26 -0000`
...
## rosbag2 (eloquent) - 0.2.3-1

The packages in the `rosbag2` repository were released into the `eloquent` distro by running `/Users/karsten/.pyenv/versions/3.7.4/bin/bloom-release --rosdistro eloquent --track eloquent rosbag2` on `Mon, 18 Nov 2019 22:03:23 -0000`
...
## rosbag2 (eloquent) - 0.2.2-1

The packages in the `rosbag2` repository were released into the `eloquent` distro by running `/home/mjcarroll/.local/bin/bloom-release --ros-distro eloquent rosbag2` on `Wed, 13 Nov 2019 15:07:46 -0000`
...
## rosbag2 (eloquent) - 0.2.1-2

The packages in the `rosbag2` repository were released into the `eloquent` distro by running `/Users/karsten/.pyenv/versions/3.7.4/bin/bloom-release --rosdistro eloquent --track eloquent rosbag2` on `Thu, 24 Oct 2019 05:24:45 -0000`
...
## rosbag2 (eloquent) - 0.2.1-1

The packages in the `rosbag2` repository were released into the `eloquent` distro by running `/Users/karsten/.pyenv/versions/3.7.4/bin/bloom-release --rosdistro eloquent --track eloquent rosbag2` on `Thu, 24 Oct 2019 05:16:48 -0000`
...
## rosbag2 (dashing) - 0.1.8-1

The packages in the `rosbag2` repository were released into the `dashing` distro by running `/usr/bin/bloom-release -r dashing -t dashing rosbag2` on `Wed, 16 Oct 2019 16:44:46 -0000`
...
## rosbag2 (dashing) - 0.1.6-1

The packages in the `rosbag2` repository were released into the `dashing` distro by running `/Users/karsten/.pyenv/versions/3.7.0/bin/bloom-release --rosdistro dashing --track dashing rosbag2` on `Fri, 20 Sep 2019 16:18:48 -0000`
...
## rosbag2 (dashing) - 0.1.3-1

The packages in the `rosbag2` repository were released into the `dashing` distro by running `/usr/bin/bloom-release --rosdistro dashing --track dashing rosbag2` on `Wed, 12 Jun 2019 21:05:04 -0000`
...
## rosbag2 (dashing) - 0.1.2-1

The packages in the `rosbag2` repository were released into the `dashing` distro by running `/Users/karsten/.pyenv/versions/3.7.0/bin/bloom-release --rosdistro dashing --track dashing rosbag2` on `Tue, 21 May 2019 01:32:04 -0000`
...
## rosbag2 (dashing) - 0.1.1-1

The packages in the `rosbag2` repository were released into the `dashing` distro by running `/Users/karsten/.pyenv/versions/3.7.0/bin/bloom-release -r dashing -t dashing rosbag2` on `Thu, 09 May 2019 07:06:29 -0000`
...
## rosbag2 (dashing) - 0.1.0-1

The packages in the `rosbag2` repository were released into the `dashing` distro by running `/Users/karsten/.pyenv/versions/3.7.0/bin/bloom-release -r dashing -t dashing rosbag2` on `Thu, 09 May 2019 03:26:33 -0000`
...
## rosbag2 (dashing) - 0.1.0-0

The packages in the `rosbag2` repository were released into the `dashing` distro by running `/Users/karsten/.pyenv/versions/3.7.0/bin/bloom-release -r dashing -t dashing rosbag2` on `Thu, 09 May 2019 03:22:13 -0000`
...
## rosbag2 (crystal) - 0.0.7-0

The packages in the `rosbag2` repository were released into the `crystal` distro by running `/Users/karsten/.pyenv/versions/2.7.15/bin/bloom-release --rosdistro crystal --track crystal rosbag2` on `Mon, 08 Apr 2019 17:55:20 -0000`
...
## rosbag2 (crystal) - 0.0.6-0

The packages in the `rosbag2` repository were released into the `crystal` distro by running `/Users/karsten/.pyenv/versions/2.7.15/bin/bloom-release --rosdistro crystal --track crystal rosbag2 --edit` on `Wed, 27 Feb 2019 22:02:21 -0000`
...
## rosbag2 (crystal) - 0.0.5-1

The packages in the `rosbag2` repository were released into the `crystal` distro by running `/Users/karsten/.pyenv/versions/2.7.15/bin/bloom-release --rosdistro crystal --track crystal rosbag2` on `Wed, 27 Feb 2019 21:48:32 -0000`
...
## rosbag2 (crystal) - 0.0.5-0

The packages in the `rosbag2` repository were released into the `crystal` distro by running `/Users/karsten/.pyenv/versions/2.7.15/bin/bloom-release --rosdistro crystal --track crystal rosbag2` on `Thu, 27 Dec 2018 23:02:55 -0000`
...
## rosbag2 (crystal) - 0.0.4-1

The packages in the `rosbag2` repository were released into the `crystal` distro by running `/Users/karsten/.pyenv/versions/3.7.0/bin/bloom-release --rosdistro crystal --track crystal rosbag2` on `Thu, 20 Dec 2018 03:01:57 -0000`
...
## rosbag2 (crystal) - 0.0.4-0

The packages in the `rosbag2` repository were released into the `crystal` distro by running `/Users/karsten/.pyenv/versions/3.7.0/bin/bloom-release --rosdistro crystal --track crystal rosbag2` on `Thu, 20 Dec 2018 02:55:25 -0000`
...
## rosbag2 (crystal) - 0.0.3-0

The packages in the `rosbag2` repository were released into the `crystal` distro by running `/Users/karsten/.pyenv/versions/2.7.15/bin/bloom-release --rosdistro crystal --track crystal rosbag2` on `Sat, 15 Dec 2018 02:43:52 -0000`
...
## rosbag2 (crystal) - 0.0.2-0

The packages in the `rosbag2` repository were released into the `crystal` distro by running `/Users/karsten/.pyenv/versions/2.7.15/bin/bloom-release --ros-distro crystal --track crystal rosbag2` on `Wed, 12 Dec 2018 16:39:47 -0000`
...
## rosbag2 (crystal) - 0.0.1-1

The packages in the `rosbag2` repository were released into the `crystal` distro by running `/Users/karsten/.pyenv/versions/2.7.15/bin/bloom-release --ros-distro crystal --override-release-repository-url https://github.com/ros2-gbp/rosbag2-release.git rosbag2` on `Wed, 12 Dec 2018 01:58:31 -0000`
...
## rosbag2 (crystal) - 0.0.1-0

The packages in the `rosbag2` repository were released into the `crystal` distro by running `/Users/karsten/.pyenv/versions/3.7.0/bin/bloom-release --rosdistro crystal --track crystal rosbag2 --edit` on `Wed, 12 Dec 2018 00:39:16 -0000`
